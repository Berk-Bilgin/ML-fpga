...
architecture behav of Encoder is 
    ...
    "Encoder,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcku15p-ffve1517-1-i,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=58.496000,HLS_SYN_LAT=900,HLS_SYN_TPT=749,HLS_SYN_MEM=249,HLS_SYN_DSP=813,HLS_SYN_FF=80229,HLS_SYN_LUT=240302,HLS_VERSION=2020_1}";
