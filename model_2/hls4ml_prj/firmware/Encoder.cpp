...
void Encoder(
    ...
    nnet::zeropad1d_cl<input_t, layer18_t, config18>(input_time_series, layer18_out); // zp1d_q_conv1d_4

    hls::stream<layer2_t> layer2_out("layer2_out");
    #pragma HLS STREAM variable=layer2_out depth=64
    nnet::conv_1d_cl<layer18_t, layer2_t, config2>(layer18_out, layer2_out, w2, b2); // q_conv1d_4

    hls::stream<layer19_t> layer19_out("layer19_out");
    #pragma HLS STREAM variable=layer19_out depth=68
    nnet::zeropad1d_cl<layer2_t, layer19_t, config19>(layer2_out, layer19_out); // zp1d_q_conv1d_5

    hls::stream<layer5_t> layer5_out("layer5_out");
    #pragma HLS STREAM variable=layer5_out depth=64
    nnet::conv_1d_cl<layer19_t, layer5_t, config5>(layer19_out, layer5_out, w5, b5); // q_conv1d_5

    hls::stream<layer20_t> layer20_out("layer20_out");
    #pragma HLS STREAM variable=layer20_out depth=67
    nnet::zeropad1d_cl<layer5_t, layer20_t, config20>(layer5_out, layer20_out); // zp1d_q_conv1d_6

    hls::stream<layer8_t> layer8_out("layer8_out");
    #pragma HLS STREAM variable=layer8_out depth=32
    nnet::conv_1d_cl<layer20_t, layer8_t, config8>(layer20_out, layer8_out, w8, b8); // q_conv1d_6

    hls::stream<layer21_t> layer21_out("layer21_out");
    #pragma HLS STREAM variable=layer21_out depth=35
    nnet::zeropad1d_cl<layer8_t, layer21_t, config21>(layer8_out, layer21_out); // zp1d_q_conv1d_7

    hls::stream<layer11_t> layer11_out("layer11_out");
    #pragma HLS STREAM variable=layer11_out depth=16
    nnet::conv_1d_cl<layer21_t, layer11_t, config11>(layer21_out, layer11_out, w11, b11); // q_conv1d_7

    auto& layer14_out = layer11_out;
    hls::stream<layer15_t> layer15_out("layer15_out");
    #pragma HLS STREAM variable=layer15_out depth=1
    nnet::dense<layer11_t, layer15_t, config15>(layer14_out, layer15_out, w15, b15); // q_dense_1

    nnet::linear<layer15_t, result_t, linear_config17>(layer15_out, layer17_out); // q_activation_8
